...
<template>
  ...
  <svg
    v-else-if="amenity === 'Aire acondicionado'"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
    stroke-width="1.8"
  ...
  >
    ...
    <g
      ...
      stroke-width="1.5"
    >
      <path d="M18.346 4.5H5.654c-.629 0-1.154.525-1.154 1.154v5.77c0 .628.525 1.153 1.154 1.153h12.692c.629 0 1.154-.525 1.154-1.154v-5.77c0-.629-.525-1.154-1.154-1.154" />
  ...
  <svg
    v-else-if="amenity === 'Barbacoa' || amenity === 'BBQ'"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
    stroke-width="1.8"
  ...
  <svg
    v-else-if="amenity === 'Piscina' || amenity === 'Piscina privada'"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
    stroke-width="1.8"
  ...
  <svg
    v-else-if="
      amenity === 'Vistas al campo' ||
      amenity === 'Vistas a la montaña'
    "
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
  ...
  <svg
    v-else-if="amenity === 'Cerca de la playa'"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
    stroke-width="1.8"
  ...
  <svg
    v-else-if="amenity === 'Rutas de montaña' || amenity === 'Senderismo'"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
    stroke-width="1.8"
  ...
  <svg
    v-else-if="amenity === 'Mascotas permitidas'"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
    stroke-width="1.8"
